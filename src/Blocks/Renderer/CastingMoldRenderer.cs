...
{
	public class CastingMoldRenderer : IRenderer
	{
		...
		public int RenderRange { get { return 24; } }
		...
		public CastingMoldRenderer(BlockPos pos, ICoreClientAPI api, Cuboidf[]? fillQuadsByLevel = null)
		{
			...
			api.Event.RegisterRenderer(this, EnumRenderStage.Opaque, "castingmoldrenderer");
		}
		...
		public void OnRenderFrame(float deltaTime, EnumRenderStage stage)
		{
			...
			prog.ModelMatrix = ModelMat.Identity().Translate(pos.X - camPos.X, pos.Y - camPos.Y, pos.Z - camPos.Z)
				.Translate(1 - rect.X1 / 16f, 1.01f / 16f + Math.Max(0, Level / 16f - 0.0625f / 3), 1 - rect.Z1 / 16f)
				.RotateX(90 * GameMath.DEG2RAD).Scale(0.5f * rect.Width / 16f, 0.5f * rect.Length / 16f, 0.5f)
				.Translate(-1, -1, 0).Values;
