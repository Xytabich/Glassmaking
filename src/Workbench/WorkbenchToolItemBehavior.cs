...
{
	/// <summary>
	/// Describes the behavior of a tool (which is an item).
	/// </summary>
	public abstract class WorkbenchToolItemBehavior
	{
		...
		public WorkbenchToolItemBehavior(string toolCode, BlockEntity blockentity, Cuboidf[] boundingBoxes)
		{
